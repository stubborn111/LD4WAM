...
Canonical registry names (one per concrete architecture class):
    la_tri_system_idm / LaTriSystemIDMArchitecture
...
Usage:
    ...
    arch = build_architecture("la_tri_system_idm", cfg)
"""
...
def register_architecture(
    ...
    *,
    ...
    Args:
        ...
        framework: Architecture family (e.g. ``"la_tri_system"``).
        variant: Variant within the family (e.g. ``"idm"``).
